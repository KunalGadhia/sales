 ...
 */
package com.spacewood.sales.config;

import com.mchange.v2.c3p0.ComboPooledDataSource;
import com.spacewood.sales.user.Role;
 ...
 */
@Configuration
@ComponentScan(basePackages = "com.spacewood.sales")
public class SalesConfiguration {
    @Value("${sales.db.driver_class}")
    private String driverClassname;

    @Value("${sales.db.connection_string}")
    ...
    public static PropertyPlaceholderConfigurer getPropertyPlaceholderConfigurer() throws IOException {
        ...
        ppc.setLocations(
                resourceLoader.getResource(System.getProperty("SALES_CONFIGURATION_FILE")));
        return ppc;
    }
